  ...
  const TABLE_ROWS = [
    {
      sex: "MALE",
      sexCount:
        parseInt(oValueForMale) +
        parseInt(aValueForMale) +
        parseInt(bValueForMale) +
        parseInt(abValueForMale),
      O: oValueForMale,
      A: aValueForMale,
      B: bValueForMale,
      AB: abValueForMale,
    ...
    },
    {
      sex: "FEMALE",
      sexCount:
        parseInt(oValueForFemale) +
        parseInt(aValueForFemale) +
        parseInt(bValueForFemale) +
        parseInt(abValueForFemale),
      O: oValueForFemale,
      A: aValueForFemale,
      B: bValueForFemale,
      AB: abValueForFemale,
    ...
    <Card className="h-full w-full">
      <table className="w-full min-w-max table-auto text-left">
        ...
        <tbody>
          {TABLE_ROWS.map(
            (
              { sex, sexCount, O, A, B, AB, age, ftCount, rrCount, rlCount },
              index
            ) => (
              <tr key={sex}>
                {[
