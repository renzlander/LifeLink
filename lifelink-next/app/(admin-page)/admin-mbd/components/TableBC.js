...
export function BloodCollectionTable({ bloodCollection }) {
  const totalSuccessCount = bloodCollection.reduce(
    ...
    <Card className="h-full w-full">
      <table className="w-full min-w-max table-auto text-left">
        <thead>
          ...
          <tr>
            <th className="border-b border-r border-blue-gray-100 bg-gray-50 p-4">
              <Typography
                variant="small"
                color="blue-gray"
            ...
            <th className="border-b border-r border-blue-gray-50 p-4">
              <Typography
                variant="small"
                color="blue-gray"
                className="font-normal leading-none opacity-70"
            ...
            return (
              <tr key={blood_type}>
                ...
                <td className={classes}>
                  ...
                  >
                    {0}{" "}
                    {/* You should update this to display spoilage based on your business logic */}
                  </Typography>
                </td>
              </tr>
            );
