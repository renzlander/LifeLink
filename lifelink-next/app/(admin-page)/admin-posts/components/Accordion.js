  ...
  return (
    <div>
      {interestedDonor.map(({ blood_request_id }) => (
        <Accordion
          key={blood_request_id}
          open={openAccordions[blood_request_id]}
          icon={<Icon id={1} open={openAccordions[blood_request_id]} />}
        >
          <AccordionHeader
            onClick={() => handleAccordionOpen(blood_request_id)}
          >
