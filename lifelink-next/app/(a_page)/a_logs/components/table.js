...
import { ArrowDownTrayIcon, MagnifyingGlassIcon, TrashIcon, DocumentArrowDownIcon } from "@heroicons/react/24/outline";
...
function formatTime(dateTimeString) {
    ...
    const formattedTime = new Date(dateTimeString).toLocaleTimeString(undefined, options);
            ...
            <CardBody className="overflow-scroll px-0">
                ...
                <table className="w-full min-w-max table-auto text-left">
                    <thead>
                        <tr>
                            {TABLE_HEAD.map((head) => (
                                <th key={head.key} className="border-y border-blue-gray-100 bg-blue-gray-50/50 p-4 sticky top-0">
