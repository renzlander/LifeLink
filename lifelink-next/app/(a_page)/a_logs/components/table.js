...
export function LogsTable() {
    ...
    const fetchData = async (page) => {
        try {
            ...
            response = await axios.get(`${laravelBaseUrl}/api/get-audit-trail?page=${page}&sort=${sortColumn}&order=${sortOrder}`, {
                headers: {
            ...
            <CardBody className="overflow-x-auto px-0">
                <div className="mb-4 ml-4 mr-4 flex justify-end items-center">
                    <div className="flex w-full shrink-0 gap-2 md:w-max">
                        <Select onChange={handleSelectModule} label="Modules" value={module}>
                            {modules.map((module) => (
