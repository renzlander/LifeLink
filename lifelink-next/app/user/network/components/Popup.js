      ...
      <Dialog open={open} handler={() => setOpen(false)}>
        ...
        <DialogBody divider className="flex flex-col gap-4 items-center">
          <Typography className="text-sm text-blue-gray-500 text-center">
            Note: By confirming your interest, Red Cross staff may contact you
            for further details. Your contact information will be used solely
            for donation coordination. Donating blood is voluntary, free, and
            not compulsory. We appreciate your willingness to contribute to this
            life-saving cause.
          </Typography>
...
export function CancelRequest({}) {
  ...
  const handleCancelRequest = async () => {
    try {
      ...
      const response = await axios
        .post(
          `${laravelBaseUrl}/api/cancel-request-blood`,
          {
            reason: reason,
          },
          {
    ...
    <>
      ...
      <Dialog open={open} handler={() => setOpen(false)}>
        ...
        <DialogBody divider className="flex flex-col gap-4 items-center">
          ...
          />
          <Typography className="text-sm text-blue-gray-500 text-center">
            Note: By canceling your blood request, you are indicating that you
            no longer need blood.
          </Typography>
          <Typography className="font-semibold text-sm text-red-600 text-center">
