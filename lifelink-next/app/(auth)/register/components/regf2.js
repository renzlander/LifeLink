...
import { Card, Input, Select, Option, Checkbox, Button, Typography, Spinner } from "@material-tailwind/react";
    ...
    <Card className='mt-6 flex justify-center items-center' color="transparent" shadow={false}>
      ...
      <form onSubmit={handleSubmit} className="mt-8 mb-2 max-w-screen-lg sm:w-full">
        ...
        <div className="flex justify-center">
          <Button type="submit" variant="contained" className='w-full flex items-center justify-center gap-5' disabled={!isChecked || !isFormValid || isSubmitting} >
